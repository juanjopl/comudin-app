...
if (isset($_SESSION['user'])) {
    ...
    // Prepara y ejecuta la consulta SQL para obtener los comentarios del post
    $sql = "SELECT i.comment, i.commentator, u.foto 
        FROM instacomments as i 
        JOIN users as u ON i.commentator = u.username
        WHERE i.post = :idPost";
